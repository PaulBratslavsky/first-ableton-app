 ...
 * with an optional manual override. Updates pause while `frozen` (e.g. pinned).
 */
export function useKeyEstimate(pitches: number[], frozen: boolean) {
