...
- **Several tracks at once** — put the Max for Live device on as many tracks as you like. They elect a hub so the app keeps one connection but sees every track, and a **track picker** appears in the header to follow one or fold them all together.
